...
def isBuyPointByTICK = (TICK_LocalRegionLowest == AVG_TICK[1]) and AVG_TICK > AVG_TICK[1] and TICK_C > TICK_L and TICK_C > TICK_C[1] and MOVING_AVG_TICK > MOVING_AVG_TICK[1];

def isSellPointByTICK = TICK_LocalRegionHighest == AVG_TICK[1] and AVG_TICK < AVG_TICK[1] and TICK_C < TICK_C[1] and TICK_C < TICK_O and MOVING_AVG_TICK < MOVING_AVG_TICK[1];
...
def isBuyPointByADD = ADD_LocalRegionLowest == AVG_ADD[1] and AVG_ADD > AVG_ADD[1]  and ADD_C > ADD_L and ADD_C - ADD_L > 5 and (MOVING_AVG_ADD > MOVING_AVG_ADD[1] or ADD_L > ADD_L[1] );

def isSellPointByADD = ADD_LocalRegionHighest == AVG_ADD[1] and AVG_ADD < AVG_ADD[1] and AVG_ADD < 1000 and (MOVING_AVG_ADD < MOVING_AVG_ADD[1]) ;
...
def isBuyPoint = (BuyPointScore >= BuyScore);
